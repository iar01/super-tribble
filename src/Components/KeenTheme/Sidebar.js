...
import Student from "../../media/svg/students.svg";
import sub from "../../media/svg/renew.svg";
import Home from "../../media/svg/home.svg";
import report from "../../media/svg/pie-chart.svg";
import Marks from "../../media/svg/marks.svg";
import QuestionPaper from "../../media/svg/question.svg";
import Exam from "../../media/svg/exam.svg";
import class_logo from "../../media/svg/class.svg";
          ...
          >
            ...
            >
              ...
              <ul className="menu-nav">
                ...
                <li className="menu-item menu-item-submenu menu-item-open menu-item-here">
                ...
                <li className="menu-item menu-item-submenu menu-item-open menu-item-here">
                  <a href="/Students-list" className="menu-link menu-toggle">
                    <span className="svg-icon menu-icon">
                      {/*begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg*/}
                      <img src={Student} alt="..." height="20px" />
                      {/*end::Svg Icon*/}
                    </span>
                ...
                <li className="menu-item menu-item-submenu menu-item-open menu-item-here">
                  <a href="/Reports" className="menu-link menu-toggle">
                    <span className="svg-icon menu-icon">
                      {/*begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg*/}
                      <img src={report} alt="..." height="20px" />
                      {/*end::Svg Icon*/}
                    </span>
                ...
                <li className="menu-item menu-item-submenu menu-item-open menu-item-here">
                  <a href="/Question-Paper" className="menu-link menu-toggle">
                    <span className="svg-icon menu-icon">
                      {/*begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg*/}
                      <img src={QuestionPaper} alt="..." height="20px" />
                      {/*end::Svg Icon*/}
                    </span>
                ...
                <li className="menu-item menu-item-submenu menu-item-open menu-item-here">
                  <a href="/Classes" className="menu-link menu-toggle">
                    <span className="svg-icon menu-icon">
                      {/*begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg*/}
                      <img src={class_logo} alt="..." height="20px" />
                      {/*end::Svg Icon*/}
                    </span>
